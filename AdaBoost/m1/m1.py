# Reference: https://towardsdatascience.com/adaboost-from-scratch-37a936da3d50
import numpy as np
from sklearn.tree import DecisionTreeClassifier
import pandas as pd

def compute_error(y, y_pred, w_i) -> float:
    '''
...
def compute_alpha(error) -> float:
    '''
    Calculate the weight of a weak classifier m in the majority vote of the final classifier.
    The alpha in chapter 10.1 of The Elements of Statistical Learning. 
    The more accurate the classifier is, the higher its alpha(weight) will be.
    Arguments:
...
def update_weights(w_i, alpha, y, y_pred):
    ...
    Boosts the weights of the misclassified instances. Arguments:
...
class AdaBoost:
    ...
    def fit(self, X, y, M=100):
        ...
        for m in range(0, M):
            ...
            # (b) compute error
            error_m: float = compute_error(y, y_pred, w_i)
